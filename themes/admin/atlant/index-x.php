...
<div class="row" style="margin-top:20px;">
    ...
    <div class="col-md-3">
        ...
        <div class="widget widget-default widget-item-icon">
            ...
            <div class="widget-data">
                <div class="widget-int num-count"><?php echo get_total_member();?></div>
                <div class="widget-title">Registred users</div>
                <div class="widget-subtitle">On <?php echo cfg('app_name');?></div>
            </div>                          
        </div>                            
    ...
    <div class="col-md-3">
        ...
        <div class="widget widget-success widget-item-icon">
            ...
            <div class="widget-data">
                <div class="widget-int num-count"><?php echo get_total_visitor();?></div>
                <div class="widget-title">Total visitors</div>
                <div class="widget-subtitle">That visited our wifi today from <?php echo get_total_campaign();?> campaign</div>
            </div>                           
        </div>
    ...
    <div class="col-md-3">
        ...
        <div class="widget widget-primary widget-item-icon">
            ...
            <div class="widget-data">
                ...
                <div class="widget-subtitle">Total Brand on <?php echo cfg('app_name');?></div>
            </div>                           
        </div>
    ...
    <div class="col-md-3">
        ...
        <div class="widget widget-warning widget-item-icon">
            ...
            <div class="widget-data">
                <div class="widget-int num-count"><?php echo get_total_hotspot();?></div>
                <div class="widget-title">Hotspot</div>
                <div class="widget-subtitle">Total Brand on <?php echo cfg('app_name');?></div>
            </div>                           
        </div>
