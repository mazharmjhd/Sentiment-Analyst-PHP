...
<html lang="en" class="body-full-height">
    <head>        
        ...
        <!-- CSS INCLUDE -->        
        <link rel="stylesheet" type="text/css" id="theme" href="<?php echo themeUrl();?>css/theme-custom-kta.css"/>
        <!-- EOF CSS INCLUDE -->                                  
    </head>
    <body>
                ...
                <div class="lsb-access">
                    <div class="lsb-box">
                        ...
                        <div class="user animated fadeIn">
                            <img src="<?php echo themeUrl();?>assets/images/users/user2.jpg" alt="John Doe"/>
